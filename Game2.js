...
function preload() {
    ...
    game.load.tilemap('level1', 'Mapas/Level 2/N1.json', null, Phaser.Tilemap.TILED_JSON);
    game.load.image('tiles-1', 'Mapas/Level 2/tiles-1.png');
    game.load.spritesheet('player', 'Ima/Personajes/P1.png', 34, 41);
    game.load.image('background', 'Ima/Fondos/F4.png');
    game.load.image('Door', 'Ima/Personajes/Puerta2.png');
    game.load.image('bullet', 'Ima/Personajes/boom.png');
    game.load.image('disparo', 'Ima/Personajes/disparo.png');
    game.load.audio('Fondo', 'Audios/F2.mp3');
    ...
    //Enemigos
    game.load.spritesheet('enemy', 'Ima/Personajes/E1.png', 34, 41);
...
function create() {
    ...
    // prueba enemy = enemy1.create(10, 10, 'enemy');
    
    enemy = enemy1.create(100, game.world.randomY, 'enemy');
    ...
    enemy = enemy1.create(2500, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(2600, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(2700, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(2800, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(2900, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3000, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3100, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3200, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3300, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3400, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3500, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3600, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3700, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3800, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(3900, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(4000, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(4100, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(4200, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(4300, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(4400, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(4500, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(4600, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);

    enemy = enemy1.create(4700, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [0, 2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);
    ...
    enemy = enemy1.create(game.world.randomX, game.world.randomY, 'enemy');
    enemy.animations.add('a1', [2, 3, 5], 5, true);
    enemy.animations.play('a1', 3, true);
...
function Nivel () {
    ...
    window.location.replace("Jefe.html");
